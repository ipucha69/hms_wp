...
import AssignBed from "./subComponents/AssignBed";
import BedList from "./subComponents/BedList";
            ...
            <div>
              <Box
                ...
                <Tabs
                    ...
                    sx={{ color: "#0A365C" }}
                >
                    <Tab label="Bed Allotment List" {...a11yProps(0)} />
                    <Tab label="Assign Bed Allotment" {...a11yProps(1)} />
                </Tabs>
              </Box>
