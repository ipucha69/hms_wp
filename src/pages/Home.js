    ...
    return (
        ...
        <div className="px-4">
            ...
            >
                ...
                <div className="px-2">
                <h4 className="text-white text-xl font-light">10</h4>
            ...
            >
                ...
                <div className="px-2">
                <h4 className="text-white text-xl font-light">TZS 700,000,000</h4>
                <h4 className="text-white text-sm font-light pb-0.5">
                    Total Sales
                </h4>
                </div>
            ...
            >
                ...
                <div className="px-2">
                <h4 className="text-white text-xl font-light">TZS 680,000,000</h4>
                <h4 className="text-white text-sm font-light pb-0.5">
                    Total Cash Sales
                </h4>
                </div>
            ...
            >
                ...
                <div className="px-2">
                <h4 className="text-white text-xl font-light">TZS 20,000,000</h4>
                <h4 className="text-white text-sm font-light pb-0.5">
                    Total Debtors Sales
                </h4>
                </div>
            ...
            >
                ...
                <h4 className="text-white text-xl font-light">
                    53,000 <span className="text-base">Litres</span>
                </h4>
                <h4 className="text-white text-sm font-light pb-0.5">
                    Available Stock
                </h4>
            ...
            >
                ...
                <div className="px-2">
                <h4 className="text-white text-xl font-light">TZS 560,000,000</h4>
                <h4 className="text-white text-sm font-light pb-0.5">
                    Total Purchases
                </h4>
                </div>
            ...
            >
                ...
                <div className="px-2">
                <h4 className="text-white text-xl font-light">TZS 14,000,000</h4>
                <h4 className="text-white text-sm font-light pb-0.5">
                    Total Expenses
                </h4>
                </div>
